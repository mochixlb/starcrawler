...
const SHARE_OPTIONS: ShareOption[] = [
  ...
  },
  {
    ...
    url: (shareUrl) => `mailto:?subject=${encodeURIComponent("Check out this Star Crawl")}&body=${encodeURIComponent(shareUrl)}`,
  },
];
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="grid grid-cols-4 gap-3">
            {SHARE_OPTIONS.map((option) => (
              ...
              >
                ...
                <span className="text-xs font-crawl font-bold uppercase tracking-wider" style={{ letterSpacing: "0.05em" }}>
                  {option.name}
                </span>
              </button>
            ))}
        ...
        {/* URL Copy Section */}
        <div>
          <label className="mb-2 block font-crawl text-sm font-bold uppercase tracking-wider text-crawl-yellow/70" style={{ letterSpacing: "0.1em" }}>
            Link
          </label>
